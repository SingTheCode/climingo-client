...
export default function SearchedPlace({ id, address, name }: ClimbingPlace) {
  return (
    <div
      id={id.toString()}
      className="w-full h-[8.5rem] pt-[2rem] border-solid border-b-[0.1rem] border-shadow-lighter"
    >
